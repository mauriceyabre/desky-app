                        ...
                        <table class="table text-gray-600 align-middle fw-semibold table-row-dashed fs-6 gy-4 dataTable no-footer" id="kt_table_projects">
                            <thead>
                                <tr class="text-start text-muted fs-7 text-uppercase gs-0">
                                    <th>ID</th>
                                    <th class="col w-100 min-w-300px">Progetto</th>
                                    <th class="col min-w-125px text-center px-0">Fase</th>
                                    <th class="col min-w-125px text-center px-0">Data</th>
                            ...
                            <tbody>
                                <tr v-for="(project, index) in projects" :key="index">
                                    ...
                                    <td class="text-center">{{ moment(project?.completed_at).fromNow() }}</td>
                                    <td class="text-end">
